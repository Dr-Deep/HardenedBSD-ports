...
<<<<<<< HEAD
_LIST_OF_WITH_FEATURES=	debug debuginfo lto sanitize ssp testing
_DEFAULT_WITH_FEATURES=	lto ssp
=======
_LIST_OF_WITH_FEATURES=	debug debuginfo lto \
			sanitize ssp testing 
...
.if ${OSVERSION} >= 1500026 || (${OSVERSION} < 1500000  && ${OSVERSION} > 1402500)
